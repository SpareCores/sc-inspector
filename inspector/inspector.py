...
EXCLUDE_INSTANCES: list[tuple[str, str]] = [
    ...
    ("gcp", "a3-megagpu-8g"),
    ("gcp", "c2d-highcpu-32"),
    ("gcp", "c3d-highmem-16-lssd"),
    ("gcp", "c3d-highmem-180-lssd"),
    ("gcp", "c3d-highmem-30-lssd"),
    ("gcp", "c3d-highmem-360-lssd"),
    ("gcp", "c3d-highmem-60-lssd"),
    ("gcp", "c3d-highmem-8-lssd"),
    ("gcp", "c3d-highmem-90-lssd"),
    ("gcp", "c3-standard-192-metal"),
    ("gcp", "h3-standard-88"),
    ("gcp", "m1-megamem-96"),
    ("gcp", "m1-ultramem-160"),
    ("gcp", "m1-ultramem-40"),
...
def start(ctx, exclude, start_only):
    ...
    for (vendor, server), (srv, regions, zones) in available_servers().items():
        ...
        if vendor == "gcp":
            ...
            is_preemptible = server.startswith("e2")
