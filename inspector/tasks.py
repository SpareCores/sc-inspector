...
class StressNg(lib.DockerTask):
    ...
    command: str = "-c \"nice -n -20 stress-ng --metrics --cpu $(nproc) --cpu-method jmp -t 20 -Y /dev/stderr\""
...
class StressNgSingleCore(lib.DockerTask):
    ...
    version_docker_opts: dict = dict(entrypoint="sh")
    version_command: str = "-c \"stress-ng --version | awk '{print $3}'\""
    command: str = "-c \"nice -n -20 stress-ng --metrics --cpu 1 --cpu-method jmp -t 20 -Y /dev/stderr\""
